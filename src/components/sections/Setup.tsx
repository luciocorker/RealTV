...
const setupSteps = [
  {
    ...
    description: (
      <>
        ...
        <a href="http://aftv.news/4965394" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-semibold">aftv.news/4965394</a>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        <strong className="text-foreground">Downloader App:</strong> Enter code <span className="text-primary font-bold">4965394</span> and press GO
        <br /><br />
