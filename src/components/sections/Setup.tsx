...
const setupSteps = [
  {
    ...
    description: (
      <>
        ...
        <a href="http://aftv.news/8920047" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-semibold">aftv.news/8920047</a>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        <strong className="text-foreground">Downloader App:</strong> Enter code <span className="text-primary font-bold">8920047</span> and press GO
        <br /><br />
