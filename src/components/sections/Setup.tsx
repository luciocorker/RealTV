...
const setupSteps = [
  {
    ...
    description: (
      <>
        ...
        <a href="http://aftv.news/9920189" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-semibold">aftv.news/9920189</a>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        <strong className="text-foreground">Downloader App:</strong> Enter code <span className="text-primary font-bold">9920189</span> and press GO
        <br /><br />
